package me.nykorrin.amber.util;
...
public class DataHandler {
    ...
    public static class JSON extends me.nykorrin.ayaka.util.DataHandler {
        ...
        public void saveJSON(@NotNull Object obj) {
            ...
            try {
                FileUtils.writeStringToFile(file, cached, String.valueOf(StandardCharsets.UTF_8));
            } catch(IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static class YML extends me.nykorrin.ayaka.util.DataHandler {
    ...
    public static class PROPS extends me.nykorrin.ayaka.util.DataHandler {
